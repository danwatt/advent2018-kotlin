...
class Day5Test {
    ...
    fun example1() {
        ...
        assertThat(Day5().react("aaAaAa")).isEqualTo("aa")
        assertThat(Day5().react("aaAaA")).isEqualTo("a")
        assertThat(Day5().react("aaAaAA")).isEqualTo("")
    }

    @Test
    fun part1() {
        assertThat(Day5().partOne()).isEqualTo(TestHelpers.decode(0x5f377435))
    }
    ...
    @Test
    fun example2() {
        assertThat(Day5().findProblematic("dabAcCaCBAcCcaDA")).isEqualTo('c' to 4)
    }

    @Test
    fun part2() {
        assertThat(Day5().partTwo()).isEqualTo(TestHelpers.decode(0x5f3749dd))
    }
}